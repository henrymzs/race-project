<h1>Projeto Corrida</h1>
  ...
  <table>
        <tr>
            ...
            <td>
                <b>Objetivo:</b>
                <p>O desafio será criar uma lógica de um jogo de vídeo game para simular corridas de Mario Kart, levando em consideração as regras e mecânicas abaixo.</p>
            </td>
        </tr>
    </table>
